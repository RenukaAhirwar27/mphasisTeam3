...
public class Connection implements Runnable {
    ...
    // we will also read from the initial client message, what the clients id is
    ...
    public void run(){ //threading method
        ...
        try{
            ...
            //we also need to add this connection to the exchange's dictionary of connections
